  ...
  return (
    ...
    >
      {showWhatsapp && (
        ...
        >
          <span className="absolute right-full mr-3 text-xs font-semibold text-ink bg-surface/95 backdrop-blur border border-line rounded-full px-3 py-1.5 shadow-lg opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 pointer-events-none whitespace-nowrap">
            Chat on WhatsApp
          </span>

          <span className="relative w-14 h-14 rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 flex items-center justify-center hover:scale-110 hover:shadow-xl hover:shadow-[#25D366]/40 active:scale-95 transition-all duration-200 border border-white/20">
      ...
      {showMessenger && (
        ...
        >
          ...
          <span className="relative w-14 h-14 rounded-full bg-gradient-to-br from-[#00B2FF] to-[#006AFF] shadow-lg shadow-[#006AFF]/30 flex items-center justify-center hover:scale-110 hover:shadow-xl hover:shadow-[#006AFF]/40 active:scale-95 transition-all duration-200 border border-white/20">
            <svg
              width="28"
              height="28"
              viewBox="0 0 24 24"
